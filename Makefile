...
CXXFILES = src/gcn.cpp src/parser.cpp src/sparse.cpp src/module.cpp src/variable.cpp src/rand.cpp
HFILES = src/gcn.h src/parser.h src/sparse.h src/module.h src/variable.h src/rand.h
